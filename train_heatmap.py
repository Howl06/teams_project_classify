...
def main():
    ...
    exper_mame = "new_lr_{}_{}_{}".format(hyper_params["learning_rate"], "optim.NAdam", hyper_params["learning_speed"])
    ...
    # log_model(experiment, net, model_name="mobilenet_v3_large")
        ...
        confusion_matrix_heatmap = experiment.create_confusion_matrix(labels=list(cla_dict.values()),max_categories=27,max_examples_per_cell=1000,image_shape=(224,224,3))
        ...
        for test_data in test_bar:
            ...
            for pre_index, image in enumerate(test_images):
                ...
                heat_image_list.append(visualization)
            ...
            confusion_matrix_heatmap.compute_matrix(test_labels, predict_y, images=heat_image_list, image_shape=(224,224,3))
            # ConfusionMatrixCallbackReuseImages(experiment, test_labels, predict_y, confusion_matrix_heatmap)
        ...
        title="confusion_matrix_heatmap, Epoch %d" % (epoch + 1),
        file_name="confusion_matrix_heatmap-%03d.json" % (epoch + 1),
        )
